...
if (validate) {
	// check session for admin & clinic
	if ((!session.getAttribute("user_type").equals("admin") && !session.getAttribute("user_type").equals("clinic"))
