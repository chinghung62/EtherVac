...
if (execute) {
	...
	if (vaccine != null) {
		if (vaccine.isExist() && vaccine.isReady()) {
	rc.put("isbn", vaccine.getBarcode());
	rc.put("name", vaccine.getName());
	rc.put("manufacturer", vaccine.getManufacturer());
	rc.put("ok", true);
		} else {
	rc.put("error_code", 400);
	rc.put("message", "Vaccine not found.");
