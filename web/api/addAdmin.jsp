...
if (execute) {
	...
	if (!clinic.isExist()) {
		if (!admin.isExist()) {
			boolean ok = u_admin.addAdmin((String) d.get("address"), (String) d.get("name"),
					(String) d.get("phone_no"), (String) d.get("email"));
			...
			rc.put("error_code", 400);
			rc.put("message", "The admin already exists.");
			rc.put("description", "Bad Request: The admin already exists");
		}
	} else {
		rc.put("error_code", 400);
		rc.put("message", "The address already exists as a clinic.");
		rc.put("description", "Bad Request: The address already exists as a clinic");
	}
		} else {
	rc.put("error_code", 500);
	rc.put("description", "Internal Server Error: Smart Contract Error");
