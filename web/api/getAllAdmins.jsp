...
if (execute) {
	...
	ArrayList<Admin> admins = u_admin.getAllAdmins();

	if (admins != null) {
		for (Admin admin : admins) {
	adminDict = new HashMap<String, Object>();
	adminDict.put("count", admin.getCount());
	adminDict.put("address", admin.getAddress());
	adminDict.put("name", admin.getName());
	adminDict.put("phone_no", admin.getPhoneNo());
	adminDict.put("email", admin.getEmail());
